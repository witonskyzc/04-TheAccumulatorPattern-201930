...
def run_test_factorial():
    ...
    # Test 3:
    answer_from_oracle = math.factorial(101)
    answer_from_my_code = factorial(101)
    ...
    # Test 5:
    answer_from_oracle = math.factorial(53)
    answer_from_my_code = factorial(53)
...
def run_test_count_cosines_from():
    ...
    # Test 4:
    expected = 0
    answer = count_cosines_from(6, 21, 2)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(1, 6, .21)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 2
    answer = count_cosines_from(4, 10, 0.59)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 3:
    expected = 2.64535  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(2, 21)
